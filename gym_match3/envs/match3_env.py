...
class Match3Env(gym.Env):
    ...
    def step(self, action):
        ...
        killed_mon = self.__game._sweep_died_monster()
        ...
        if (self.__episode_counter >= self.rollout_len or killed_mon or self.__game.get_player_hp() <= 0):
            episode_over = True
            self.__episode_counter = 0
            self.result_step += 1
